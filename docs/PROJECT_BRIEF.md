        ...
        ringbuf exists to solve a narrow, inspectable developer-tooling problem:
        Fixed-capacity ring buffer with O(1) append, overwrite-oldest, indexable, and reversible. Zero dependencies.
        ...
        Topics: circular-buffer, data-structures, python, ring-buffer, zero-dependencies
